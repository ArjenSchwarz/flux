...
- [x] 1. Add macOS layout gate test <!-- id:n55vfw7 -->
...
- [x] 2. Flip IPadLayoutGate to return true on macOS <!-- id:n55vfw8 -->
...
- [x] 3. Add DayDetail macOS toolbar and nav-title formatter tests <!-- id:n55vfw9 -->
...
- [x] 4. Update DayDetailView for macOS chrome <!-- id:n55vfwa -->
...
- [x] 5. Wire macOS chrome on Dashboard and FluxApp scene <!-- id:n55vfwb -->
