...
- [x] 1. Make HistoryCardChrome.kpi optional <!-- id:gy1z6r6 -->
...
- [x] 2. Write tests for new PeriodSummary aggregates and Totals comparators <!-- id:gy1z6r7 -->
...
- [x] 3. Implement new PeriodSummary fields, record types, generic comparator, and Totals extensions <!-- id:gy1z6r8 -->
...
- [x] 4. Write tests for HistoryStatsFormatters <!-- id:gy1z6r9 -->
...
- [x] 5. Implement HistoryStatsFormatters <!-- id:gy1z6ra -->
...
- [x] 6. Extend MockFluxAPIClient.historyDays fixtures so previews populate every tile <!-- id:gy1z6rb -->
...
- [x] 7. Write tests for HistoryStatsOverviewCard static helpers and tap-action behaviour <!-- id:gy1z6rc -->
...
- [x] 8. Implement HistoryStatsOverviewCard <!-- id:gy1z6rd -->
...
- [x] 9. Wire HistoryStatsOverviewCard into HistoryView <!-- id:gy1z6re -->
...
- [x] 10. Refresh agent notes for views and viewmodels <!-- id:gy1z6rf -->
