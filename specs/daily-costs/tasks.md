...
- [x] 9. Write FluxCoreTests/PricingPeriodTests.swift covering Codable round-trip, YYYY-MM-DD string compare ordering, and equality <!-- id:osag2lq -->
  - Stream: 2
  - Requirements: [1.2](requirements.md#1.2), [1.3](requirements.md#1.3)

- [x] 10. Implement FluxCore/Pricing/PricingPeriod.swift and PricingPeriodDraft.swift <!-- id:osag2lr -->
...
- [x] 11. Write FluxCoreTests/URLSessionAPIClientPricingTests.swift covering all five endpoints plus 400/401/404/409 error mapping <!-- id:osag2ls -->
...
- [x] 12. Implement URLSessionAPIClient pricing extensions and FluxAPIError.pricingValidation cases (including concurrentWrite) <!-- id:osag2lt -->
...
- [x] 13. Write FluxCoreTests/PricingServiceTests.swift covering refresh, mutation fold and fire-and-forget refetch <!-- id:osag2lu -->
...
- [x] 14. Implement FluxCore/Pricing/PricingService.swift as @Observable @MainActor <!-- id:osag2lv -->
...
- [x] 15. Write FluxCoreTests/DayCostsTests.swift covering DaySummary.costs(forDate:in:) and DayEnergy.costs(in:), including the off-peak nil fallback to eInput <!-- id:osag2lw -->
  - Blocked-by: osag2lr (Implement FluxCore/Pricing/PricingPeriod.swift and PricingPeriodDraft.swift)
  - Stream: 2
...
- [x] 16. Implement FluxCore/Pricing/DayCosts.swift with DaySummary and DayEnergy extensions <!-- id:osag2lx -->
...
- [x] 17. Write FluxCoreTests/PeriodCostsTests.swift with property-based tests for overlap symmetry, cost linearity, and net invariant, plus partial-coverage and empty-range cases <!-- id:osag2ly -->
...
- [x] 18. Implement FluxCore/Pricing/PeriodCosts.swift with compute(days:pricing:) <!-- id:osag2lz -->
...
- [x] 19. Write PricingViewModel tests covering list/add/edit/delete, validation error surfacing, and the one-tap overlap remediation flow <!-- id:osag2m0 -->
...
- [x] 20. Implement Flux/Flux/Settings/Pricing/PricingViewModel.swift wrapping PricingService <!-- id:osag2m1 -->
...
- [x] 21. Write snapshot tests for PricingPeriodsView covering empty, single open-ended, multiple sorted, and partially-loaded states <!-- id:osag2m2 -->
...
- [x] 22. Implement Flux/Flux/Settings/Pricing/PricingPeriodsView.swift with list, add affordance, swipe-to-delete, and empty state <!-- id:osag2m3 -->
...
- [x] 23. Write snapshot tests for PricingEditor covering create, edit, per-error-code banners, and the remediation surface <!-- id:osag2m4 -->
  - Blocked-by: osag2m1 (Implement Flux/Flux/Settings/Pricing/PricingViewModel.swift wrapping PricingService)
  - Stream: 2
  - Requirements: [3.4](requirements.md#3.4), [3.5](requirements.md#3.5), [3.6](requirements.md#3.6)

- [x] 24. Implement Flux/Flux/Settings/Pricing/PricingEditor.swift (sheet with 4dp rate inputs, destructive delete with confirmation, one-tap remediation button) <!-- id:osag2m5 -->
...
- [x] 25. Wire Settings entry on iOS and macOS in SettingsView.swift and instantiate PricingService at app startup (FluxApp.swift / FluxiOSAppDelegate.swift) <!-- id:osag2m6 -->
...
- [x] 26. Write snapshot tests for CostsCard covering positive net, negative net, and zero off-peak savings <!-- id:osag2m7 -->
  - Blocked-by: osag2lx (Implement FluxCore/Pricing/DayCosts.swift with DaySummary and DayEnergy extensions)
  - Stream: 2
  - Requirements: [4.1](requirements.md#4.1), [4.7](requirements.md#4.7)

- [x] 27. Implement Flux/Flux/DayDetail/CostsCard.swift (four rows, AUD formatting, leading minus on negative net) <!-- id:osag2m8 -->
  - Blocked-by: osag2m7 (Write snapshot tests for CostsCard covering positive net, negative net, and zero off-peak savings)
  - Stream: 2
  - Requirements: [4.1](requirements.md#4.1), [4.7](requirements.md#4.7)

- [x] 28. Wire costs computation into DayDetailViewModel and render CostsCard below DayInFiveBlocksPanel in DayDetailView.swift <!-- id:osag2m9 -->
...
- [x] 29. Write snapshot tests for HistoryPeriodCostsCard covering full coverage and partial coverage with the N-of-M caption <!-- id:osag2ma -->
...
- [x] 30. Implement Flux/Flux/History/HistoryPeriodCostsCard.swift (four tiles, partial-coverage caption) <!-- id:osag2mb -->
...
- [x] 31. Wire periodCosts computation into HistoryViewModel and render HistoryPeriodCostsCard below HistoryStatsOverviewCard in HistoryView.swift <!-- id:osag2mc -->
