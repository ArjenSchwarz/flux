...
- [ ] 1. Extract internal/derivedstats package with own Reading type <!-- id:qwdi4hx -->
...
- [ ] 2. Write tests for dynamo *Attr conversion functions <!-- id:qwdi4hy -->
...
- [ ] 3. Implement dynamo *Attr types + conversion functions + DerivedStats bundle <!-- id:qwdi4hz -->
...
- [ ] 4. Write tests for new dynamo store methods (UpdateItem migration + UpdateDailyEnergyDerived + GetDailyEnergy + struct-tag coverage) <!-- id:qwdi4i0 -->
...
- [ ] 5. Implement dynamo store: WriteDailyEnergy → UpdateItem; add UpdateDailyEnergyDerived + GetDailyEnergy <!-- id:qwdi4i1 -->
  ...
  - Blocked-by: qwdi4i0 (Write tests for new dynamo store methods (UpdateItem migration + UpdateDailyEnergyDerived + GetDailyEnergy + struct-tag coverage)), methods, methods
  - Stream: 1
...
- [ ] 6. Write tests for poller CloudWatch Metrics shim <!-- id:qwdi4i2 -->
...
- [ ] 7. Implement poller Metrics struct + CloudWatchAPI interface <!-- id:qwdi4i3 -->
...
- [ ] 8. Write tests for the poller summarisation pass (all AC 6.1 / 6.2 scenarios) <!-- id:qwdi4i4 -->
...
- [ ] 9. Implement poller summarisation pass + wire into Run <!-- id:qwdi4i5 -->
...
- [ ] 10. Write tests for Lambda /day past-date branch <!-- id:qwdi4i6 -->
...
- [ ] 11. Implement Lambda /day past-date storage read + skip-readings-query <!-- id:qwdi4i7 -->
...
- [ ] 12. Write tests for Lambda /history derived-stats surfacing + today live-compute + AC 4.9 failure mode <!-- id:qwdi4i8 -->
...
- [ ] 13. Implement Lambda /history per-row derived-stats + today live-compute + today error tolerance <!-- id:qwdi4i9 -->
...
- [ ] 14. Write cross-handler equivalence test (AC 6.6) <!-- id:qwdi4ia -->
...
- [ ] 15. Write end-to-end DynamoDB Local round-trip integration test (AC 6.7) <!-- id:qwdi4ib -->
...
- [ ] 16. Property-based tests for derivedstats determinism + dynamo conversion round-trip <!-- id:qwdi4ic -->
...
- [ ] 17. Write iOS DayEnergy + CachedDayEnergy decoding tests <!-- id:qwdi4id -->
...
- [ ] 18. Implement iOS DayEnergy + CachedDayEnergy extensions; add lightweight migration if needed <!-- id:qwdi4ie -->
...
- [ ] 19. Update CloudFormation: add poller IAM grants for UpdateItem + PutMetricData <!-- id:qwdi4if -->
...
- [ ] 20. Verify Lambda IAM stanza in CloudFormation already covers GetItem + Query on flux-daily-energy <!-- id:qwdi4ig -->
...
- [ ] 21. Add `make integration` Makefile target <!-- id:qwdi4ih -->
...
- [ ] 22. Capture performance baselines + post-feature measurements (AC 2.5, 4.7, 4.8) <!-- id:qwdi4ii -->
