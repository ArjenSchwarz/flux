...
- [ ] 6. Write DashboardViewModel activity-tier tests (red) <!-- id:ntwcpw1 -->
...
- [ ] 7. Implement DashboardViewModel activity-tier and Control Center reload debounce <!-- id:ntwcpw2 -->
...
- [ ] 8. Add FluxAppDelegate (Mac-only) with unit test <!-- id:ntwcpw3 -->
...
- [ ] 9. Add FluxRefreshCoordinator and FluxKeyboardCommands <!-- id:ntwcpw4 -->
...
- [ ] 10. Wire FluxApp for macOS scenes and lifecycle <!-- id:ntwcpw5 -->
...
- [ ] 11. Update AppNavigationView and SidebarView for macOS
...
- [ ] 12. Wire refresh coordinator install/uninstall in DashboardView, HistoryView, DayDetailView <!-- id:ntwcpw6 -->
...
- [ ] 13. Add AppearsActiveMonitor and apply to DashboardView <!-- id:ntwcpw7 -->
...
- [ ] 14. Add Day Detail keyboard navigation (Mac-only)
...
- [ ] 15. Write SettingsViewModel save tests for credential mirror + notification (red) <!-- id:ntwcpw8 -->
...
- [ ] 16. Update SettingsViewModel to write through iCloudURLMirror and post credentials notification <!-- id:ntwcpw9 -->
...
- [ ] 17. Apply Liquid Glass scroll polish on macOS detail views
