...
- [ ] 1. Add EveningNight and EveningNightBlock Go response types <!-- id:qxucsl2 -->
...
- [ ] 2. Generate and commit Melbourne sun lookup table <!-- id:qxucsl3 -->
...
- [ ] 3. Write sanity tests for melbourneSunriseSunset <!-- id:qxucsl4 -->
...
- [ ] 4. Implement melbourneSunriseSunset <!-- id:qxucsl5 -->
...
- [ ] 5. Write tests for integratePload including the design's worked example <!-- id:qxucsl6 -->
...
- [ ] 6. Implement integratePload <!-- id:qxucsl7 -->
...
- [ ] 7. Write tests for findEveningNight covering all req 4.1 scenarios <!-- id:qxucsl8 -->
...
- [ ] 8. Implement findEveningNight and buildEveningNightBlock helper <!-- id:qxucsl9 -->
...
- [ ] 9. Wire findEveningNight into handleDay and extend day_test.go integration cases <!-- id:qxucsla -->
...
- [ ] 10. Add BenchmarkFindEveningNight <!-- id:qxucslb -->
  - Mirror BenchmarkFindPeakPeriods: 8640 reading-fixture, run findEveningNight in B.Loop pattern, include -benchmem
  - Blocked-by: qxucsl9 (Implement findEveningNight and buildEveningNightBlock helper)
  - Stream: 1
  - References: internal/api/compute_test.go

- [ ] 11. Add Swift EveningNight types and update DayDetailResponse with decode tests and literal call-site fixes <!-- id:qxucslc -->
...
- [ ] 12. Write DayDetailViewModel tests for eveningNight handling <!-- id:qxucsld -->
...
- [ ] 13. Add eveningNight property and loadDay wiring to DayDetailViewModel <!-- id:qxucsle -->
...
- [ ] 14. Implement EveningNightCard SwiftUI view and update MockFluxAPIClient preview fixture <!-- id:qxucslf -->
...
- [ ] 15. Wire EveningNightCard into DayDetailView <!-- id:qxucslg -->
