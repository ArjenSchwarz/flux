...
- [x] 1. Add DailyUsage and DailyUsageBlock Go response types <!-- id:31p9ruh -->
...
- [x] 2. Write tests for findDailyUsage covering all req 4.1 fixtures <!-- id:31p9rui -->
...
- [x] 3. Implement findDailyUsage and buildDailyUsageBlock helper <!-- id:31p9ruj -->
...
- [x] 4. Wire findDailyUsage into handleDay and update day_test.go integration cases <!-- id:31p9ruk -->
...
- [x] 5. Add BenchmarkFindDailyUsage <!-- id:31p9rul -->
...
- [x] 6. Add Swift DailyUsage types and update DayDetailResponse <!-- id:31p9rum -->
...
- [x] 7. Update FluxCore decode tests for DailyUsage <!-- id:31p9run -->
...
- [x] 8. Update DayDetailViewModel and its tests for dailyUsage <!-- id:31p9ruo -->
...
- [x] 9. Implement DailyUsageCard SwiftUI view and wire into DayDetailView <!-- id:31p9rup -->
...
- [x] 10. Update MockFluxAPIClient preview fixture for dailyUsage <!-- id:31p9ruq -->
