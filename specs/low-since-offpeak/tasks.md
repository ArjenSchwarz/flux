...
- [x] 5. startOfDaySydney helper replaces lastOffpeakEnd
...
- [x] 6. /status computes low24h since Sydney midnight today
...
- [x] 7. Status handler tests reflect the midnight boundary
...
- [x] 8. Documentation reflects the redirect
