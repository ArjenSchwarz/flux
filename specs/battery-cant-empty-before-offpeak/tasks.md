...
- [ ] 1. Backend (Go) — write helper tests (red) <!-- id:p1ve881 -->
...
- [ ] 2. Backend (Go) — implement helpers (green) <!-- id:p1ve882 -->
...
- [ ] 3. Backend (Go) — handler integration tests (red) <!-- id:p1ve883 -->
...
- [ ] 4. Backend (Go) — add field + wire handler (green) <!-- id:p1ve884 -->
