...
//
// Sibling: integratePload in integrate.go is a near-duplicate that reads
// Pload instead of Ppv and does not return sampleCount. Decision 6 in
...
// algorithm here must be mirrored in integratePload.
